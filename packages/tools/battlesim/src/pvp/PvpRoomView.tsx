  ...
  return (
    <LiveBattle
      ...
      banner={connection === 'reconnecting' ? (
        <p role="status" className="m-0 flex items-center gap-2 border-b border-solid border-warn bg-warn-soft px-3 py-2 font-mono text-[11px] uppercase tracking-[0.08em] text-txt">
