...
import {
  loadLegacyTables,
  type LegacyTables,
} from "../../../../engine/loader/legacy/legacy-mapper";
import {
...
} from "../../../../engine/loader/littletiles";
import {
  LT_STRUCTURE_ATTRIBUTES,
  LT_STRUCTURE_ID_MAP,
  structureSupport,
} from "../../../../engine/loader/littletiles-support";
import { serializeBlockState, parseBlockState } from "../../../../engine/normalizer";
import type { SchematicStructure, TileEntity, UnifiedBlock } from "../../../../engine/types";
