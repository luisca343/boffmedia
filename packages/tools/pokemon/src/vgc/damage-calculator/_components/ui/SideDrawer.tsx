  ...
  return (
    <>
      ...
      <aside
        role="dialog"
        aria-label={title}
        className="fixed bottom-0 right-0 top-[var(--tool-sticky-top,0px)] z-[75] flex w-[min(400px,94vw)] flex-col border-l border-solid border-line-2 bg-panel shadow-[var(--shadow)] animate-[bm-drawer-in_0.22s_cubic-bezier(0.2,0.7,0.3,1)] motion-reduce:animate-none"
      >
