...
import { DkStat, DkSeg, DkSplit, DkTrend, DkHeat } from "@boffmedia/ui/datakit"
import { useSessionStats } from "../../tracker-core/hooks/useSessionStats"
import { useComparisonElo } from "../../tracker-core/hooks/useComparisonElo"
import { useRegulationMeta } from "../../tracker-core/hooks/useRegulationMeta"
import type { PokemonUsage, LeadPairStats } from "../../tracker-core/utils/sessionStats"
...
export function TrStats({ sessionId, session, sessions }: { sessionId: string; session?: Session; sessions: Session[] }) {
  const t = useVgcT("tracker.sessionStats")
...
function ActivityHeat({ stats }: { stats: ReturnType<typeof useSessionStats>["stats"] }) {
  const t = useVgcT("tracker.sessionStats")
  const dayLabels = useVgcT("tracker.sessionStats.days")
  const grid = useMemo(() => {
