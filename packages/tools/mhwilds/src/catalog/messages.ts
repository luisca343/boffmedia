    ...
    "tools": {
      "mhwilds": {
        ...
        "tree": {
          ...
          "progress": "Progreso",
          "dragHint": "Arrastra el espacio vacío para mover",
          "zoomHint": "Rueda desplaza la página · Ctrl+rueda hace zoom",
          "canvasLabel": "Árbol de mejoras de armas",
          "zoomIn": "Acercar",
          "zoomOut": "Alejar",
        ...
        "bestiary": {
          ...
          "dropCapture": "Captura",
          "dropOther": "Otro",
          "unknownDrop": "Objeto desconocido",
          "rarity": "Rareza",
          "dropSource": "Obtenci\u00f3n",
          "dropQuantity": "Cantidad",
          "dropChance": "Probabilidad",
          "anatomyHint": "Selecciona una parte para resaltarla",
          "damageProfile": "Valores de hitzone",
          "physical": "F\u00edsico",
          "breakSchema": "Esquema de roturas",
          "breakSchemaHint": "Roturas registradas por el juego",
          "breakStage": "Rotura {stage}",
          "breakStageThreshold": "Rotura {stage} \u00b7 umbral {count}",
          "anatomy": "Esquema anatómico",
          "anatomyAlt": "Esquema de partes de {name}",
          "gameSource": "Datos del juego",
          "reportParts": "Partes visibles en el informe",
          "noReportParts": "No hay partes visibles registradas.",
          "unknownPart": "Parte desconocida",
          "partDamage": "Daño por parte",
          "part": "Parte",
          "partHealth": "Salud",
          "damageSlash": "Corte",
          "damageBlunt": "Golpe",
          ...
          "damageDragon": "Draco",
          "breakable": "Rompible",
          "severable": "Cercenable",
          "weakPoint": "Punto débil",
          "partCount": "{count, plural, one {# parte} other {# partes}}",
          "breakCount": "{count, plural, one {# rotura} other {# roturas}}",
          "breakRewards": "Recompensas por rotura",
          "breakRewardsHint": "Materiales obtenidos al romper esta parte",
          "unassignedBreakPart": "Parte no especificada",
          "afterBreak": "Tras romper",
          "damageLegend": "Valores de hitzone del juego; cuanto mayor el porcentaje, más daño recibe esa parte."
        },
        "build_planner": {
          "compare": {
            "mode_edit": "Editar",
          ...
          "forge": {
            ...
            "choose_route": "Ruta de {name}",
            "steps": "{count, plural, one {# paso de forja} other {# pasos de forja}}",
            "zenny": "{amount} z",
            "untracked": "Sin receta directa:"
          },
          "wishlist": {
            "title": "Lista de deseos",
            "itemCount": "{count, plural, one {# objetivo} other {# objetivos}}",
            "nav": "Lista ({count})",
            "empty": "Aún no hay objetivos. Añade equipo desde el buscador de la lista.",
            "emptyLead": "Tus objetivos y el coste total aparecerán aquí cuando añadas algo a la lista.",
            "toPlanner": "Volver al planificador",
            "unresolved": "{count, plural, one {# objetivo no está disponible} other {# objetivos no están disponibles}} en el catálogo actual.",
            "targetMissing": "No está en el catálogo actual",
            "materialsLead": "Coste acumulado para fabricar todos los objetivos desde cero.",
            "noMaterials": "No hay materiales registrados",
            "noMaterialsLead": "No hay recetas disponibles para estos objetivos todavía.",
            "addTitle": "Añadir objetivos",
            "searchWeaponsTab": "Armas",
            "searchArmorTab": "Armaduras",
            "addButton": "Añadir a la lista",
            "rarityFilter": "Filtrar por rareza",
            "allRarities": "Todas las rarezas",
            "skillFilter": "Filtrar por habilidad",
            "allSkills": "Todas las habilidades",
            "slotFilter": "Filtrar por ranuras",
            "allSlotCounts": "Cualquier número de ranuras",
            "atLeastSlots": "{count, plural, one {Al menos # ranura} other {Al menos # ranuras}}",
            "searchCharmsTab": "Amuletos",
            "searchDecorationsTab": "Decoraciones",
            "searchCharms": "Busca un amuleto…",
            "searchDecorations": "Busca una decoración…",
            "charmFilter": "Filtrar amuletos por nivel",
            "decorationFilter": "Filtrar decoraciones por ranura",
            "elementFilter": "Filtrar por elemento",
            "allElements": "Todos los elementos",
            "noElement": "Sin elemento",
            "ailmentFilter": "Filtrar por aflicción",
            "allAilments": "Todas las aflicciones",
            "noAilment": "Sin aflicción",
            "affinityFilter": "Filtrar por afinidad",
            "allAffinity": "Cualquier afinidad",
            "negativeAffinity": "Afinidad negativa",
            "neutralAffinity": "Afinidad neutra",
            "positiveAffinity": "Afinidad positiva",
            "rankFilter": "Filtrar por rango",
            "allRanks": "Todos los rangos",
            "decorationKindFilter": "Filtrar por equipo",
            "allEquipment": "Todo el equipo",
            "allCharmLevels": "Todos los niveles",
            "allDecorationSlots": "Todas las ranuras",
            "searchWeapons": "Busca un arma…",
            "searchArmor": "Busca una pieza…",
            "weaponFilter": "Filtrar armas por tipo",
            "armorFilter": "Filtrar armaduras por pieza",
            "allWeaponTypes": "Todos los tipos",
            "allArmorPieces": "Todas las piezas",
            "searchHint": "Explora el catálogo",
            "searchHintLead": "Combina la búsqueda y los filtros para encontrar objetivos.",
            "noMatches": "Sin coincidencias",
            "noMatchesLead": "Prueba con otro nombre o cambia el filtro.",
            "resultCount": "{count, plural, one {# resultado} other {# resultados}}",
            "resultLimit": "Primeros {count}",
            "currentBuild": "Build actual",
            "weapon": "Arma",
            "armor": "Armadura",
            "charm": "Amuleto",
            "decoration": "Decoración",
            "charmLevel": "Nivel {level}",
          ...
          "errors": {
            ...
            "loadWishlist": "Error al cargar el catálogo de la lista."
          }
        },
        "armor_page": {
          ...
          "highRank": "Rango alto",
          "lowRank": "Rango bajo",
          "pieceCount": "{count, plural, one {# pieza} other {# piezas}}",
          "selectedPieces": "{count}/{total} piezas seleccionadas",
          "addSelected": "Añadir seleccionadas",
          "removeSelected": "Quitar seleccionadas",
          "addedToWishlist": "{count, plural, one {# pieza añadida a la lista} other {# piezas añadidas a la lista}}",
          "removedFromWishlist": "{count, plural, one {# pieza quitada de la lista} other {# piezas quitadas de la lista}}",
          "alreadyInWishlist": "Las piezas ya estaban en la lista",
          "noSelected": "Selecciona al menos una pieza para añadirla a la lista.",
          "planSet": "Planificar conjunto",
          "defense": "Defensa",
          "materialsTitle": "Materiales del conjunto",
          "zenny": "{amount} z",
          "noMaterials": "Sin materiales registrados",
          "noMaterialsLead": "Selecciona al menos una pieza para calcular el coste.",
          "assetUnavailable": "Sin raster 2D del juego",
          "assetNote": "Las vistas 2D usan las previsualizaciones extraídas del juego. Si el paquete no incluye una ranura concreta, se muestra el icono de esa ranura.",
          "selectSet": "Selecciona un conjunto",
          "selectSetLead": "Elige un conjunto para revisar sus piezas, habilidades y materiales.",
          "noResults": "Sin resultados",
          "noResultsLead": "Ningún conjunto coincide con los filtros actuales.",
        ...
        "manifest": {
          ...
          "armor": {
            ...
            "description": "Explora conjuntos, piezas y materiales de armadura."
          },
          "wishlist": {
            "name": "Lista de materiales",
            "tagline": "Monster Hunter Wilds",
            "category": "Planificación",
            "description": "Reúne objetivos y calcula todos los materiales necesarios."
          }
        }
      }
    }
    ...
    "tools": {
      "mhwilds": {
        ...
        "tree": {
          ...
          "progress": "Progress",
          "dragHint": "Drag empty space to pan",
          "zoomHint": "Wheel scrolls the page · Ctrl+wheel zooms",
          "canvasLabel": "Weapon upgrade tree",
          "zoomIn": "Zoom in",
          "zoomOut": "Zoom out",
          "fit": "Fit to view",
          "final": "Final",
        ...
        "bestiary": {
          ...
          "dropCapture": "Capture",
          "dropOther": "Other",
          "unknownDrop": "Unknown item",
          "rarity": "Rarity",
          "dropSource": "Source",
          "dropQuantity": "Quantity",
          "dropChance": "Chance",
          "anatomyHint": "Select a part to highlight it",
          "damageProfile": "Hitzone values",
          "physical": "Physical",
          "breakSchema": "Break schema",
          "breakSchemaHint": "Breaks recorded by the game",
          "breakStage": "Break {stage}",
          "breakStageThreshold": "Break {stage} \u00b7 threshold {count}",
          "anatomy": "Anatomy schema",
          "anatomyAlt": "Part schema for {name}",
          "gameSource": "Game data",
          "reportParts": "Parts shown in the report",
          "noReportParts": "No visible report parts recorded.",
          ...
          "damageFire": "Fire",
          "damageWater": "Water",
          "damageThunder": "Thunder",
          "damageIce": "Ice",
          "damageDragon": "Dragon",
          "breakable": "Breakable",
          "severable": "Severable",
          "weakPoint": "Weak point",
          "partCount": "{count, plural, one {# part} other {# parts}}",
          "breakCount": "{count, plural, one {# break} other {# breaks}}",
          "breakRewards": "Break rewards",
          "breakRewardsHint": "Materials obtained by breaking this part",
          "unassignedBreakPart": "Part not specified",
          "afterBreak": "After break",
          "damageLegend": "In-game hitzone values; higher percentages mean that part takes more damage."
        },
        "build_planner": {
          "compare": {
            "mode_edit": "Edit",
          ...
          "forge": {
            ...
            "choose_route": "{name} route",
            "steps": "{count, plural, one {# forge step} other {# forge steps}}",
            "zenny": "{amount} z",
            "untracked": "No direct recipe:"
          },
          "wishlist": {
            "title": "Wishlist",
            "itemCount": "{count, plural, one {# target} other {# targets}}",
            "nav": "Wishlist ({count})",
            "empty": "No targets yet. Add equipment from the wishlist search.",
            "emptyLead": "Your targets and the total cost will appear here once you add something to the list.",
            "toPlanner": "Back to planner",
            "unresolved": "{count, plural, one {# target is not available} other {# targets are not available}} in the current catalog.",
            "targetMissing": "Not in the current catalog",
            "materialsLead": "The accumulated cost to craft every target from scratch.",
            "noMaterials": "No materials recorded",
            "noMaterialsLead": "Recipes are not available for these targets yet.",
            "addTitle": "Add targets",
            "searchWeaponsTab": "Weapons",
            "searchArmorTab": "Armor",
            "addButton": "Add to wishlist",
            "rarityFilter": "Filter by rarity",
            "allRarities": "All rarities",
            "skillFilter": "Filter by skill",
            "allSkills": "All skills",
            "slotFilter": "Filter by slots",
            "allSlotCounts": "Any number of slots",
            "atLeastSlots": "{count, plural, one {At least # slot} other {At least # slots}}",
            "searchCharmsTab": "Charms",
            "searchDecorationsTab": "Decorations",
            "searchCharms": "Search for a charm…",
            "searchDecorations": "Search for a decoration…",
            "charmFilter": "Filter charms by level",
            "decorationFilter": "Filter decorations by slot",
            "elementFilter": "Filter by element",
            "allElements": "All elements",
            "noElement": "No element",
            "ailmentFilter": "Filter by ailment",
            "allAilments": "All ailments",
            "noAilment": "No ailment",
            "affinityFilter": "Filter by affinity",
            "allAffinity": "Any affinity",
            "negativeAffinity": "Negative affinity",
            "neutralAffinity": "Neutral affinity",
            "positiveAffinity": "Positive affinity",
            "rankFilter": "Filter by rank",
            "allRanks": "All ranks",
            "decorationKindFilter": "Filter by equipment",
            "allEquipment": "All equipment",
            "allCharmLevels": "All levels",
            "allDecorationSlots": "All slots",
            "searchWeapons": "Search for a weapon…",
            "searchArmor": "Search for a piece…",
            "weaponFilter": "Filter weapons by type",
            "armorFilter": "Filter armor by piece",
            "allWeaponTypes": "All types",
            "allArmorPieces": "All pieces",
            "searchHint": "Explore the catalog",
            "searchHintLead": "Combine text search and filters to find targets.",
            "noMatches": "No matches",
            "noMatchesLead": "Try another name or change the filter.",
            "resultCount": "{count, plural, one {# result} other {# results}}",
            "resultLimit": "First {count}",
            "currentBuild": "Current build",
            "weapon": "Weapon",
            "armor": "Armor",
            "charm": "Charm",
            "decoration": "Decoration",
            "charmLevel": "Level {level}",
            "add": "Add to wishlist",
            "added": "Wishlisted",
          ...
          "errors": {
            ...
            "loadWishlist": "Could not load the wishlist catalog."
          }
        },
        "armor_page": {
          "titlePrefix": "Armor",
          ...
          "selectedPieces": "{count}/{total} pieces selected",
          "addSelected": "Add selected",
          "removeSelected": "Remove selected",
          "addedToWishlist": "{count, plural, one {# piece added to wishlist} other {# pieces added to wishlist}}",
          "removedFromWishlist": "{count, plural, one {# piece removed from wishlist} other {# pieces removed from wishlist}}",
          "alreadyInWishlist": "Those pieces are already in the wishlist",
          "noSelected": "Select at least one piece to add it to the wishlist.",
          "planSet": "Plan this set",
          "defense": "Defense",
          "materialsTitle": "Set materials",
          "zenny": "{amount} z",
          "noMaterials": "No materials recorded",
          "noMaterialsLead": "Select at least one piece to calculate its cost.",
          "assetUnavailable": "No game 2D raster",
          "assetNote": "2D views use the game's extracted equipment previews. If a specific slot is missing from the pack, its slot icon is shown.",
          "selectSet": "Select a set",
          "selectSetLead": "Choose a set to review its pieces, skills and materials.",
          "noResults": "No results",
          "noResultsLead": "No set matches the current filters.",
          "loadError": "Could not load armor"
        },
        "manifest": {
          "planner": {
            "name": "Build Planner",
          ...
          "armor": {
            ...
            "tagline": "Monster Hunter Wilds",
            "category": "Equipment",
            "description": "Browse armor sets, pieces and crafting materials."
          },
          "wishlist": {
            "name": "Material checklist",
            "tagline": "Monster Hunter Wilds",
            "category": "Planning",
            "description": "Collect targets and calculate every material you need."
          }
        }
      }
    }
