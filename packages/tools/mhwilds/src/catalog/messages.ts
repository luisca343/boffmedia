    ...
    "tools": {
      "mhwilds": {
        ...
        "bestiary": {
          ...
          "breakSchemaHint": "Umbrales extra\u00eddos del juego",
          "breakStage": "Nivel {stage} \u00b7 umbral {count}",
          ...
          "damageIce": "Hielo",
          "damageDragon": "Draco",
          "breakCount": "Rompible · {count} nivel(es)",
    ...
    "tools": {
      "mhwilds": {
        ...
        "bestiary": {
          ...
          "breakSchemaHint": "Thresholds extracted from the game",
          "breakStage": "Stage {stage} \u00b7 threshold {count}",
          ...
          "damageIce": "Ice",
          "damageDragon": "Dragon",
          "breakCount": "Breakable · {count} level(s)",
