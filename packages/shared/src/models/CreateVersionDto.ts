...
/* tslint:disable */
/* eslint-disable */
import type { EmulatorSpecDto } from './EmulatorSpecDto';
export type CreateVersionDto = {
    name: string;
    /**
     * Obligatorio para packs de Minecraft; ausente para el resto
     */
    minecraft?: string;
    /**
     * Obligatorio para packs de emulador; ausente para el resto
     */
