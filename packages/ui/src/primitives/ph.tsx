...
export function Ph({ label, style, className }: PhProps) {
  return (
    <div
      style={style}
      className={cn(
        "relative grid place-items-center min-h-[7.5rem]",
    ...
    >
      <span className="font-mono text-[0.75rem] font-medium leading-[1.5] text-txt-muted text-center px-[0.875rem]">{label}</span>
    </div>
  )
}
