export const pmdSkyPokemon: { [key: number]: string } = {
    1: "Bulbasaur",
    2: "Ivysaur",
    3: "Venusaur",
    4: "Charmander",
...
export const NIDORAN_FEMALE = 0x18
export const NIDORAN_MALE = 0x20

export const maleOnlyPokemon = [0x205, 0x6A, 0x6B, 0x108, 0x19D, 0x1C5, 0x22, 0x21, 0x80, 0x107, 0x155]
// http://bulbapedia.bulbagarden.net/wiki/Category:Female-only_Pok%C3%A9mon
export const femaleOnlyPokemon = [
    0x10D, 0x71, 0x212, 0x208, 0x1E2, 0x156, 0x7C, 0x73, 0x19C, 0x10C, 0x01F,
    0x01E, 0x109, 0x1C7, 0x1C2, 0x1C3, 0x1C4
]

export function getValidPokemon(selectLabel?: string): { label: string, value: string }[] {
    ...
    return [
        { value: "0", label: selectLabel || "Select a Pokémon" },
        ...valid
    ];
}
