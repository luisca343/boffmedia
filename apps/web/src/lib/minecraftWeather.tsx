...
export const getDayNightIcon = (ticks: number): React.JSX.Element => {
  if ((ticks >= 22500 && ticks < 24000) || (ticks >= 0 && ticks < 300)) return <Sunrise className="h-6 w-6 text-primary" />;
  ...
  if (ticks >= 12000 && ticks < 13800) return <Sunset className="h-6 w-6 text-primary" />;
  ...
  return <Cloud className="h-6 w-6 text-ink-muted" />;
};
