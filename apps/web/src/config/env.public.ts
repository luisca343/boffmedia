...
export const env = z
  .object({
    ...
    NEXT_PUBLIC_BUILD_ID: z.string().default(""),
    NEXT_PUBLIC_VERSION_FILE_SHA: z.string().default(""),
  ...
  .parse({
    ...
    NEXT_PUBLIC_VERSION_FILE_SHA: process.env.NEXT_PUBLIC_VERSION_FILE_SHA,
