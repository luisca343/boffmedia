...
const TYPE_COLORS: Record<string, { bg: string; text: string }> = {
  normal: { bg: 'bg-surface-400', text: 'text-surface-900' },
  fire: { bg: 'bg-red-500', text: 'text-white' },
  water: { bg: 'bg-secondary-500', text: 'text-white' },
  electric: { bg: 'bg-yellow-400', text: 'text-yellow-900' },
  grass: { bg: 'bg-highlight-500', text: 'text-white' },
  ice: { bg: 'bg-cyan-300', text: 'text-cyan-900' },
  fighting: { bg: 'bg-red-700', text: 'text-white' },
  poison: { bg: 'bg-accent-600', text: 'text-white' },
  ...
  ghost: { bg: 'bg-accent-800', text: 'text-white' },
  dragon: { bg: 'bg-indigo-700', text: 'text-white' },
  dark: { bg: 'bg-surface-700', text: 'text-white' },
  steel: { bg: 'bg-surface-400', text: 'text-surface-900' },
...
export default function PokemonTypeChip({ type, onClick, clickable, small }: PokemonTypeChipProps) {
  ...
  const colors = TYPE_COLORS[typeKey] || { bg: 'bg-surface-500', text: 'text-white' };
