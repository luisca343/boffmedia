...
export class BattleErrorBoundary extends React.Component<Props, State> {
    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center p-8 bg-surface-800 rounded-lg text-surface-50">
          <h2 className="text-xl font-bold mb-2 text-red-400">Battle Error</h2>
          <p className="text-surface-300 mb-4">Something went wrong in the battle.</p>
