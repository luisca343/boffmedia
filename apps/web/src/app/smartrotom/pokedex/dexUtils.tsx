...
import { TYPE_EFF } from "@boffmedia/pokemon-identity"
...
// Canonical implementation from @boffmedia/pokemon-identity.
// Lowercased for compatibility with the existing code that iterates over typeChart keys.
export const typeChart = Object.fromEntries(
  Object.entries(TYPE_EFF).map(([key, value]) => [
    key.toLowerCase(),
    Object.fromEntries(
