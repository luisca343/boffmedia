    ...
    <>
      <div className="bg-white/[0.025] border border-white/[0.06] rounded-xl p-[18px_20px]">
        <div className="flex items-center gap-3 flex-wrap mb-3.5 pb-3 border-b border-white/[0.05]">
          ...
          <span className="ml-auto font-pk-mono text-[11px] text-pk-surface-500 tracking-[0.06em] uppercase">{t(CATEGORY_LABELS[catKey]) || move.attackCategory}</span>
        </div>
      ...
      {learners.length > 0 && (
        <div className="bg-white/[0.025] border border-white/[0.06] rounded-xl p-[18px_20px]">
          <div className="flex items-center justify-between mb-2.5">
            <span className="font-pk-mono text-[10.5px] tracking-[0.1em] uppercase text-pk-surface-500">{t("move_learners")}</span>
