    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Super Efectivo contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
                ...
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Poco Efectivo contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
                ...
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Sin Efecto contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
            ...
            <div className="space-y-4">
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Débil contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
                        {weakTo.length > 0 ? (
                            weakTo.map(t => (
                                <TypeBadgeSmall key={t} type={t} />
                ...
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Resistente contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
                ...
                <div>
                    <h3 className="text-lg font-medium text-surface-100 mb-2">Inmune contra:</h3>
                    <div className="bg-surface-700/50 rounded-lg p-3 min-h-16 flex flex-wrap gap-2">
                        {immuneTo.length > 0 ? (
                            immuneTo.map(t => (
                                <TypeBadgeSmall key={t} type={t} />
