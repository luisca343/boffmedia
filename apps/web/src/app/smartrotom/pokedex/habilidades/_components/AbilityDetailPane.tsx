  ...
  return (
    <div className="bg-white/[0.025] border border-white/[0.06] rounded-xl p-[18px_20px]">
      <div className="flex items-center gap-3 flex-wrap mb-3.5 pb-3 border-b border-white/[0.05]">
        ...
        <span className="inline-flex items-center gap-1.5 px-2 py-[3px] text-[0.625rem] font-bold tracking-[0.1em] uppercase text-pk-surface-400 bg-white/[0.04] rounded">
      ...
      {carriers.length > 0 && (
        <>
          <div className="flex items-center justify-between mt-3.5 mb-2.5">
            <span className="font-pk-mono text-[0.65625rem] tracking-[0.1em] uppercase text-pk-surface-500">{t("ability_carriers")}</span>
