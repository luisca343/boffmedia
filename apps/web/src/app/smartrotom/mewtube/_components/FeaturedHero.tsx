...
export function FeaturedHero({ data }: { data: FeaturedData }) {
  ...
  return (
    <section className="relative h-[30rem] overflow-hidden">
      ...
      />
      <div className="relative z-[2] mx-auto flex h-full max-w-[102.5rem] flex-col justify-end gap-[1.125rem] px-6 py-10 md:px-10 md:py-[3.75rem]">
        <h1 className="m-0 max-w-[55rem] font-mw-display text-[clamp(1.75rem,4vw,3.25rem)] font-extrabold leading-[1.05] tracking-[-0.02em] [text-wrap:balance]">
          {data.title}
        </h1>
