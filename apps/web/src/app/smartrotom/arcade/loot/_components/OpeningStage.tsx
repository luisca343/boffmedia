        ...
        <Panel tone="magenta" glow innerClassName="p-5">
          <div className="flex items-center gap-[18px]">
            ...
            <div className="min-w-0">
              ...
              {description && (
                <p className="mt-1.5 max-w-[260px] font-ar-mono text-[11px] leading-relaxed text-ar-ink-dim">
                  {description}
                </p>
              )}
            </div>
        ...
        <Panel tone="void">
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            <Link
              ...
              className={cn(
                "ar-lift inline-flex select-none items-center justify-center gap-2 rounded-lg border border-white/25 px-4 py-2.5 font-ar text-[12px] font-semibold uppercase tracking-[0.08em] text-[#001016]",
