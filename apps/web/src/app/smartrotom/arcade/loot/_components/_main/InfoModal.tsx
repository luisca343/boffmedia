...
export function InfoModal({ isOpen, onClose, hasSession }: InfoModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-layer-1 border-2 border-cyan-500/30 max-w-2xl shadow-md shadow-cyan-500/20">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-secondary-hover">
            Cómo funcionan las Poké Cajas
          </DialogTitle>
          <DialogDescription className="text-center text-lg text-ink">
