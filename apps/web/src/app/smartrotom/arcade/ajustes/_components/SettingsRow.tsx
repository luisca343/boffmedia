...
export function SettingsRow({ label, hint, children }: SettingsRowProps) {
  return (
    <div className="grid grid-cols-[1fr_auto] items-center gap-3.5 border-b border-dashed border-white/[.06] py-3.5">
      <div>
        <div className="font-ar text-[14px] font-semibold text-ar-ink">{label}</div>
        {hint && (
          <div className="mt-1 max-w-[520px] font-ar-mono text-[11px] leading-relaxed text-ar-ink-muted">
            {hint}
          </div>
        )}
      </div>
