  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-secondary-200 to-accent-200">
      <div className="relative w-[26rem] h-[32rem] flex flex-col items-center justify-center">
        {!tabRemoved && (
          <div 
            className="absolute right-0 top-1/2 w-24 h-16 bg-yellow-300 transform translate-x-1/2 -translate-y-1/2 cursor-pointer z-0 flex items-center justify-center text-sm font-bold text-surface-800 shadow-lg rounded-r-lg"
            onClick={removeTab}
          >
            Quitar Pestaña
          </div>
