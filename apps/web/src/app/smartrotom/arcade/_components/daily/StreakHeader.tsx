...
export default function StreakHeader({ 
  ...
  return (
    <div className="bg-gradient-to-r from-secondary-soft to-secondary-soft px-5 py-3 flex items-center justify-between flex-wrap">
      <div className="flex items-center">
        <Calendar className="h-5 w-5 text-secondary-hover mr-2" />
