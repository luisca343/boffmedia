...
/**
 * Wigglypop's icon set — inline SVG, one map, no `lucide-react`.
 *
 * The set IS part of the visual identity (SMARTROTOM_V3.md §10): every glyph is a
 * 24×24 round-capped 2px stroke, which is what lets them sit next to Fredoka's
 * rounded terminals without looking imported. Mixing in a second icon library
 * would break that at a glance, so add new glyphs here rather than reaching for one.
 *
 * `crown` is the one exception: it is drawn to be *filled*, not stroked — pass
 * `filled` for it (a stroked crown reads as a squiggle at 11px).
 */
...
const PATHS = {
  ...
  filterX: '<path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z"/>',
  ...
  // ── the marketplace verbs ─────────────────────────────────────────────────
  cart: '<circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/>',
  gavel: '<path d="m14 13-7.8 7.8a2 2 0 0 1-2.8-2.8L11.2 10"/><path d="m16 16 6-6"/><path d="m8 8 6-6"/><path d="m9 7 8 8"/><path d="m21 11-8-8"/><path d="M3 21h9"/>',
  ...
  /** Drawn to be FILLED — pass `filled`. A stroked crown is mush at 11px. */
  crown:
