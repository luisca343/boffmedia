...
export function Switch({ on }: { on: boolean }) {
  return (
    <span
      aria-hidden="true"
      className={cn(
        "relative h-6 w-[42px] shrink-0 rounded-xl border border-solid transition-colors duration-200",
        "after:absolute after:left-0.5 after:top-0.5 after:h-[18px] after:w-[18px] after:rounded-full",
