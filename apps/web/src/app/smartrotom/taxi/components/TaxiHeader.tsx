...
export default function TaxiHeader({ playerPosition, playerMoney, onHistoryClick }: TaxiHeaderProps) {
  return (
    <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-secondary-soft to-secondary-soft p-4 shadow-md z-10">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center bg-secondary-active/60 px-3 py-1 rounded-full border border-secondary/30">
            <FaUserCircle className="text-secondary-hover mr-2" />
