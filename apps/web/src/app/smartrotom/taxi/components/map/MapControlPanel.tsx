...
export const MapControlPanel = ({
  ...
  return (
    <div className="absolute bottom-4 right-4 bg-white/10 backdrop-blur-sm rounded-lg shadow-lg p-3 border border-white/20 z-40">
      ...
      <div className="text-xs text-center text-secondary-hover mb-3">
        <span className="bg-secondary-soft/70 px-2 py-1 rounded-md">Arrastra para navegar</span>
      </div>
      ...
      {showResetButton && (
        <button
          ...
          className="w-full px-3 py-1.5 bg-secondary-active hover:bg-secondary-active rounded-md text-white text-xs"
