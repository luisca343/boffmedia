...
export function EmptyResults({ onClear }: { onClear: () => void }) {
  ...
  return (
    <div className="animate-pc-pop px-6 py-10 text-center motion-reduce:animate-none">
      <div className="mx-auto mb-4 flex h-[4.75rem] w-[4.75rem] items-center justify-center rounded-[20px] border border-pc-line bg-white/[.04]">
      ...
      <p className="mx-auto mb-4 max-w-[17.5rem] font-pc text-[0.84375rem] text-pc-fg-muted">
