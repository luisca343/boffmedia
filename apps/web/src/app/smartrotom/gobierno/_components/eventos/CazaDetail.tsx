...
export function CazaDetail({ ev }: { ev: Evento }) {
  ...
  return (
    <>
      ...
      <Card edgeGold className="mb-[1.125rem] p-5">
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap gap-5">
              <div>
                ...
                <div className="flex items-center gap-1.5 font-gt-display text-[0.9375rem] font-bold text-gt-ink-900">
              ...
              {ev.coordsX != null && ev.coordsZ != null && (
                <div>
                  ...
                  <div className="font-gt-mono text-[0.8125rem] text-gt-ink-700">
              ...
              {ev.participants != null && (
                <div>
                  ...
                  <div className="font-gt-display text-[0.9375rem] font-bold tabular-nums text-gt-ink-900">
                    {ev.participants}
                  </div>
                </div>
              )}
      ...
      {live && ev.rules && (
        <Card className="mb-[1.125rem] border-l-[3px] border-l-gt-info bg-gt-info/[.06] p-3.5">
          <div className="flex items-start gap-2.5">
            <Icon name="lock" size={17} className="mt-px flex-none text-gt-info" />
            <div>
              <div className="mb-0.5 text-[0.8125rem] font-bold text-gt-ink-900">{t("eventos.transparencia")}</div>
              <p className="m-0 text-[0.78125rem] leading-relaxed text-gt-ink-600">{ev.rules}</p>
            </div>
          </div>
        </Card>
      )}
              ...
              <Card key={f.key} className="p-3.5">
                <div className="mb-1.5 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-gt-display text-[0.9375rem] font-bold text-gt-ink-900">{f.label}</span>
                  </div>
                ...
                <p className="m-0 text-[0.71875rem] leading-relaxed text-gt-ink-500">{f.desc}</p>
              </Card>
            ))}
          </div>
        </div>
                    ...
                    <TR key={spc.id}>
                      ...
                      <TD className="text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <div className="h-[0.3125rem] w-14 overflow-hidden rounded-full bg-gt-paper-3">
                            <div
                      ...
                      <TD className="text-center">
                        <span className="font-gt-mono text-[0.71875rem] tabular-nums text-gt-ink-600">
