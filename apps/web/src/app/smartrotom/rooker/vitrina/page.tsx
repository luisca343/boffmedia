    ...
    <div>
      ...
      <div className="flex items-center gap-4 border-b border-rk-line p-4">
        <div className="relative h-[68px] w-[68px] flex-none">
          ...
          <span className="absolute inset-0 grid place-items-center text-[16px] font-bold tabular-nums text-rk-fg">
            {pct}%
          </span>
        </div>
        <div>
      ...
      <div className="flex gap-2 px-4 py-3">
        {(["todos", "shiny"] as Filter[]).map((f) => (
          <button
            ...
            className={cn(
              "flex-none rounded-rk-pill px-4 py-1.5 text-[13px] font-bold transition-colors",
              filter === f
