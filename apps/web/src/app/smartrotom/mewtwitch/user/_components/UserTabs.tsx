      ...
      {streamData && (
        <TabsContent value="live" className="mt-0">
          ...
          <div className="bg-layer-2 rounded-lg p-6">
            <div className="h-full bg-layer-3 rounded-lg mb-4 overflow-hidden">
              <TwitchPlayer 
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-ink">{streamData.game_name}</p>
              </div>
              ...
              {streamData.tags && streamData.tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {streamData.tags.map((tag, index) => (
                    <span key={index} className="bg-layer-3 text-ink px-2 py-1 rounded text-xs">
                      {tag}
                    </span>
                  ))}
                </div>
