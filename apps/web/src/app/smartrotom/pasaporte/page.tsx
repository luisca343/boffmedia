    ...
    return(
      <section className=" bg-yellow-200 flex bg-center bg-no-repeat bg-fixed bg-cover">
          <Book setBook={setBook}>
            <Page dataDensity="hard" book={book} number={page++} className="font-vinque bg-secondary-active flex  flex-col bg-center bg-no-repeat bg-fixed bg-cover" style={{backgroundImage: `url(/smartrotom/img/apps/pasaporte/pasaporte.png)`}} />
      ...
      return (
        <div className="flex font-bold 2xl:m-2 font-vinque justify-between items-end">
          ...
          <div className="flex items-center">
            ...
            {achievement.replay && (
              <Popover>
                <PopoverTrigger className="text-base self-end ml-2 hover:text-secondary">Ver Reptición</PopoverTrigger>
                <PopoverContent className="ml-12 w-fit h-fit page border border-edge-strong shadow-2xl">
