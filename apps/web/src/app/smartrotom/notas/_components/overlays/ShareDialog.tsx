        ...
        <div className="p-[18px]">
          <div className="mb-4 flex items-center gap-2">
            <input
              ...
              placeholder="UUID de entrenador…"
          ...
          {note.sharedWith.length ? (
            ...
            <p className="m-0 text-[13px] text-nt-fg-subtle">Solo tú tienes acceso.</p>
          )}
          ...
          >
            ...
            <span className="flex-1">
              ...
              <span className="block text-[11.5px] text-nt-fg-muted">
                {note.public ? "Cualquiera con el enlace puede verla" : "Solo personas invitadas"}
              </span>
            </span>
            <span
