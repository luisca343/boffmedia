    ...
    <div className="min-h-screen">
      <div className="container mx-auto p-6 max-w-7xl">
        <div className="flex flex-col items-center justify-center py-32">
          ...
          <h2 className="mt-8 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-secondary-hover to-secondary-hover">
            Cargando eventos...
          </h2>
          <p className="mt-2 text-ink-muted">Preparando experiencias épicas</p>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="absolute w-2 h-2 bg-secondary-hover/30 rounded-full animate-ping"
                style={{
                  top: `${20 + (i * 15)}%`,
                  left: `${10 + (i * 15)}%`,
