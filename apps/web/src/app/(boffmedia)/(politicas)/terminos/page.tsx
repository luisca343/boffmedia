...
export default function TermsOfServicePage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="mb-4 text-primary-100">
        Al utilizar nuestros servicios, aceptas estos Términos de Servicio en su
      ...
      <p className="mb-4 text-primary-100">
        ...
        nuestros servicios después de dichos cambios constituye tu aceptación de
        los nuevos términos.
      </p>
      ...
      <ul className="list-disc list-inside mb-4 text-primary-100">
        <li>
          Utilizar nuestros servicios para cualquier propósito ilegal o no
          autorizado.
        </li>
        <li>
          Interferir o interrumpir la integridad o el rendimiento de nuestros
          servicios.
        </li>
        <li>
        ...
        <li>
          Copiar, modificar, distribuir, vender o arrendar cualquier parte de
          nuestros servicios.
        </li>
      </ul>
      ...
      <p className="mb-4 text-primary-100">
        ...
        y seguirán siendo propiedad exclusiva de BoffMedia y sus licenciantes.
        El servicio está protegido por derechos de autor, marcas registradas y
        otras leyes.
      </p>
      ...
      <p className="mb-4 text-primary-100">
        ...
        la ley o se indique en nuestra política de reembolsos.
      </p>
      ...
      <p className="mb-4 text-primary-100">
        Podemos terminar o suspender tu acceso inmediatamente, sin previo aviso
        ni responsabilidad, por cualquier motivo, incluyendo, sin limitación, si
        incumples estos Términos de Servicio.
      </p>
      ...
      <p className="mb-4 text-primary-100">
        En ningún caso BoffMedia, ni sus directores, empleados, socios, agentes,
        proveedores o afiliados, serán responsables por cualquier daño
