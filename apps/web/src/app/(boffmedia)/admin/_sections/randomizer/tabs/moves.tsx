...
export default function MovesTab() {
  ...
  return (
    <AvPanel title={t("tabs.moves")} className="border-l-[3px] border-l-accent bg-accent-soft/10">
      <p className="text-sm text-txt-muted">
        {t("tabs.moves")} — Placeholder for per-control wiring (coming in later pass)
      </p>
    </AvPanel>
  )
}
