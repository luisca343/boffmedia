...
export default function TypesTab() {
  ...
  return (
    <AvPanel title={t("tabs.types")} className="border-l-[3px] border-l-accent bg-accent-soft/10">
      <p className="text-sm text-txt-muted">
        {t("tabs.types")} — Placeholder for per-control wiring (coming in later pass)
      </p>
    </AvPanel>
  )
}
