...
export default function ItemsTab() {
  ...
  return (
    <AvPanel title={t("tabs.items")} className="border-l-[3px] border-l-accent bg-accent-soft/10">
      <p className="text-sm text-txt-muted">
        {t("tabs.items")} — Placeholder for per-control wiring (coming in later pass)
      </p>
    </AvPanel>
  )
}
