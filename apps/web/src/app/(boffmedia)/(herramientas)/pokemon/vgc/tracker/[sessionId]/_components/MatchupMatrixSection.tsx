    ...
    <div className="rounded-xl border border-surface-800 bg-surface-950 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-surface-800">
        ...
        <button
          ...
          className="text-xs text-surface-500 hover:text-surface-300 transition-colors border border-surface-800 rounded px-2 py-0.5"
        >
            ...
            <tbody>
              {filtered.map((p) => {
                ...
                const wrColor =
                  ...
                  : 'text-red-400';
                return (
                  <tr key={`${p.pokemon1Id}+${p.pokemon2Id}`} className="border-b border-surface-900 hover:bg-surface-900/50 transition-colors">
