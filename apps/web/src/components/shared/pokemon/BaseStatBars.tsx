    ...
    <div>
      ...
      {STAT_ORDER.map((k) => (
        <div key={k} className="flex items-center gap-2 mb-1">
          ...
          <span className="w-8 font-mono text-xs text-right text-ink">{base[k]}</span>
      ...
      <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-edge text-xs">
        <span className="text-ink-dim font-mono">BST</span>
