  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex flex-col gap-[2px] flex-1 min-w-0 font-display text-[14px] font-bold leading-[1.1] tracking-[0.03em] uppercase">
          {title}
          {sub && <small className="font-mono text-[11px] font-normal leading-[1.3] tracking-normal normal-case text-txt-dim">{sub}</small>}
        </span>
        {badge != null && (
          <span className="font-mono text-[10px] font-semibold leading-none uppercase tracking-[0.1em] text-accent border border-solid border-accent-line bg-accent-soft py-1 px-2">
            {badge}
          </span>
        )}
        <Icon
