...
export function ActivityItem({ icon, text, time, color = "var(--orange-500)" }: ActivityItemProps) {
  return (
    <li className="flex items-center gap-[0.85rem] py-[0.8rem] border-b border-edge last:border-b-0 last:pb-0">
      <span
      ...
      <span className="text-xs text-ink-dim whitespace-nowrap">{time}</span>
    </li>
  )
}
