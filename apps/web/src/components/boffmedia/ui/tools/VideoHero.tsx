...
const DEFAULT_SRC = staticAsset(ASSET.boffmedia.img, 'tools', 'looptest.mp4');
const DEFAULT_POSTER = staticAsset(ASSET.boffmedia.img, 'tools', 'looptest.jpg');
...
export function VideoHero({ src = DEFAULT_SRC, poster = DEFAULT_POSTER, scrim = 0.7, children }: VideoHeroProps) {
  return (
