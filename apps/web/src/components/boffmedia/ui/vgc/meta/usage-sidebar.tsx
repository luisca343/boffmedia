        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSelected
                ? "bg-[var(--accent-soft)] border-[color-mix(in_srgb,var(--accent)_30%,transparent)]"
                : "hover:bg-[color-mix(in_srgb,var(--surface-3)_55%,transparent)] bg-transparent",
            )}
          >
            <span className={cn(
              "font-mono text-[11px] text-right",
              isSelected ? "text-[var(--accent-bright)]" : "text-[var(--text-dim)]",
            )}>
              #{rank}
            </span>
            <img
            ...
            <span className={cn(
              ...
              isSelected ? "text-[var(--accent-bright)]" : "text-[var(--text-muted)]",
            )}>
