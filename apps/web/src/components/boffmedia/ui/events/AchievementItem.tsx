    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-3">
          ...
          {isMedal && (
            <span className="inline-flex items-center gap-1 font-mono text-[8.5px]/none font-semibold uppercase tracking-[0.1em] text-[color:var(--rc)]">
        ...
        {a.earned && a.earnedDate ? (
          <div className="mt-3 inline-flex items-center gap-1.5 font-mono text-[10px]/none font-medium uppercase tracking-[0.08em] text-ok">
            <Icon name="check" size={12} />
            Conseguido · {formatEventDate(a.earnedDate)}
          </div>
        ) : a.globalPct != null ? (
          <div className="mt-3 grid max-w-[280px] gap-1.5">
            <span className="font-mono text-[10px]/none uppercase tracking-[0.08em] text-txt-dim">{a.globalPct}% lo tienen</span>
            <span className="block h-[5px] overflow-hidden border border-solid border-line bg-base">
