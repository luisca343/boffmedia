...
export function LoadingScreen() {
    return (
        <div className="w-full h-full flex justify-center items-center bg-primary-hover">
            <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-edge"></div>
        </div>
    );
}