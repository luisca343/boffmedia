...
export function AppErrorFallback({
  ...
  const t = useTranslations("smartrotom.appError")
  ...
  return (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-3 px-6 text-center text-current">
      ...
      <h2 className="text-xl font-semibold">{t("crashed")}</h2>
      <p className="max-w-sm text-sm opacity-70">{error.message || t("crashed")}</p>
