...
export function BotonNotification(){
    return <span aria-label={"Notificaciones"} className="rounded-lg border-0 h-8 w-8 mx-1 flex items-center justify-center group hover:bg-surface-50">
...
export function BotonAjustes(){
    return <span aria-label={"Ajustes"} className="rounded-lg border-0 h-8 w-8 mx-1 flex items-center justify-center group hover:bg-surface-50">
        <Settings strokeWidth={2} height={24} width={24} className="text-primary-400 group-hover:text-primary-600"/>
    </span>
}

export function BotonIA(){
    return <span aria-label={"IA"} className="rounded-lg border-0 h-8 w-8 mx-1 flex items-center justify-center group hover:bg-surface-50">
