...
export class ChatAppService {
  ...
  static createChat(data: CreateChatDto) {
    return rotomAuthedPOST<CreateChatResponse>('/chatapp/chat', data);
  }
   ...
   */
  static getChats() {
    return rotomAuthedGET<Chat[]>('/chatapp/chats');
  }
  ...
  static getChatById(chatId: number) {
    return rotomAuthedGET<Chat>(`/chatapp/chat/${chatId}`);
  }
  ...
  static getMessages(chatId: number, limit?: number) {
    ...
    return rotomAuthedGET<RotomMessage[]>(url);
  }
  ...
  static createMessage(chatId: number, data: CreateMessageDto) {
    return rotomAuthedPOST<CreateMessageResponse>(`/chatapp/messages/${chatId}`, data);
  }
  ...
  static updateMessage(messageId: number, data: UpdateMessageDto) {
    return rotomAuthedPUT<RotomMessage>(`/chatapp/message/${messageId}`, data);
  }
  ...
  static deleteMessage(messageId: number, data: DeleteMessageDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/message/${messageId}`, data);
  }
  ...
  static markMessageAsRead(messageId: number, data: MarkMessageReadDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/message/${messageId}/read`, data);
  }
  ...
  static markChatAsRead(chatId: number, data: MarkChatReadDto) {
    return rotomAuthedPOST<MarkChatReadResponse>(`/chatapp/chat/${chatId}/read`, data);
  }
  ...
  static reactToMessage(messageId: number, data: ReactMessageDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/message/${messageId}/react`, data);
  }
  ...
  static setChatPinned(chatId: number, data: SetChatPinnedDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/chat/${chatId}/pin`, data);
  }
  ...
  static setChatMuted(chatId: number, data: SetChatMutedDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/chat/${chatId}/mute`, data);
  }
  ...
  static addMemberToGroup(groupId: number, data: AddMemberDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/group/${groupId}/member`, data);
  }
  ...
  static removeMemberFromGroup(groupId: number, uuid: string, data: RemoveMemberDto) {
    return rotomAuthedPOST<MessageResponse>(`/chatapp/group/${groupId}/member/${uuid}`, data);
  }
  ...
  static initiateCall(chatId: number, data: InitiateCallDto) {
    return rotomAuthedPOST<CallResponse>(`/chatapp/call/${chatId}`, data);
  }
  ...
  static endCall(chatId: number, data: EndCallDto) {
    return rotomAuthedPOST<RotomMessage>(`/chatapp/call/${chatId}/end`, data);
  }
}