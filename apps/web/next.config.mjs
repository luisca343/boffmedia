...
const nextConfig = {
    ...
    transpilePackages: ['@boffmedia/ui', '@boffmedia/tool-kit', '@boffmedia/tools-minecraft', '@boffmedia/tools-mhwilds', '@boffmedia/tools-pokemon', '@boffmedia/tools-mewgenics', '@boffmedia/tools-misc', '@boffmedia/tools-battlesim'],
    typescript: {
