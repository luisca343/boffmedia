  ...
  plugins: [
    ...
    plugin(({ addBase, addComponents }) => {
      ...
      addComponents({
        ...
        ".nt-doc hr": { border: "none", height: "1px", background: "var(--nt-border-2)", margin: "1.6em 0" },
        ".nt-doc .callout": { borderLeft: "3px solid rgb(var(--nt-c-info))", background: "rgb(var(--nt-c-info) / .09)", borderRadius: "9px", padding: "12px 16px", margin: "1.2em 0" },
        ".nt-doc .callout > p": { marginBottom: ".5em" },
        ".nt-doc .callout > p:last-child": { marginBottom: "0" },
        '.nt-doc .callout[data-kind="success"]': { borderLeftColor: "rgb(var(--nt-c-success))", background: "rgb(var(--nt-c-success) / .09)" },
        '.nt-doc .callout[data-kind="warning"]': { borderLeftColor: "rgb(var(--nt-c-warning))", background: "rgb(var(--nt-c-warning) / .09)" },
        '.nt-doc .callout[data-kind="error"]': { borderLeftColor: "rgb(var(--nt-c-error))", background: "rgb(var(--nt-c-error) / .09)" },
