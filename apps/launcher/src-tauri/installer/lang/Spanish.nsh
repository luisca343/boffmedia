...
LangString boffWelcomeText ${LANG_SPANISH} "Este asistente instalará ${PRODUCTNAME} ${VERSION} en tu equipo.$\r$\n$\r$\nEl launcher se encarga de descargar, actualizar y arrancar los packs de Boffmedia: no hace falta instalar Java ni Forge por tu cuenta.$\r$\n$\r$\nPulsa Siguiente para continuar."
LangString boffDirText ${LANG_SPANISH} "El launcher se instalará en la carpeta indicada. Aquí solo va el programa: los mundos, los mods y las instancias se guardan aparte, en tu carpeta de usuario, y no se borran al desinstalar."
LangString boffFinishTitle ${LANG_SPANISH} "${PRODUCTNAME} está listo"
LangString boffFinishText ${LANG_SPANISH} "Ya puedes abrir el launcher e iniciar sesión con tu cuenta de Microsoft.$\r$\n$\r$\nSe actualiza solo: cuando haya una versión nueva te avisará dentro del propio launcher."
...
LangString MUI_UNTEXT_CONFIRM_SUBTITLE ${LANG_SPANISH} "Se quitará el launcher de tu equipo."
...
LangString webview2AbortError ${LANG_SPANISH} "No se ha podido instalar WebView2, y el launcher no funciona sin él. Prueba a lanzar el instalador otra vez."
