...
const es = {
  ...
  packDetail: {
    ...
    emulatorPack: "Pack de emulador",
    emulator: {
      title: "Emulador",
      ready: "Listo",
      setupPending: "Falta configurar",
      notFound: "No se encontró el emulador en este equipo.",
      manualPath: "ruta manual",
      locate: "Localizar…",
      change: "Cambiar…",
      useAuto: "Detectar automáticamente",
      emudeckHint: "Recomendamos instalar EmuDeck (emudeck.com): el launcher detecta sus emuladores y tus ROMs automáticamente. También puedes localizar el ejecutable a mano.",
      scan: "Buscar en mi biblioteca",
      scanFound: "{count, plural, one {# archivo encontrado} other {# archivos encontrados}} en tu biblioteca.",
      scanNone: "No se encontró ninguna ROM que coincida. Selecciónala a mano.",
      error: "No se pudo actualizar el emulador.",
    },
    userFiles: {
      title: "Archivos que debes aportar",
      lead: "Este pack incluye archivos que el servidor no distribuye (por ejemplo, el volcado de tu propio cartucho). Selecciónalos aquí; se verifican contra el hash del pack antes de aceptarse.",
      provide: "Seleccionar archivo",
      provided: "Aportado",
      missingCount: "Faltan {count}",
      complete: "Completo",
...
const en = {
  ...
  packDetail: {
    ...
    emulatorPack: "Emulator pack",
    emulator: {
      title: "Emulator",
      ready: "Ready",
      setupPending: "Setup pending",
      notFound: "The emulator was not found on this machine.",
      manualPath: "manual path",
      locate: "Locate…",
      change: "Change…",
      useAuto: "Auto-detect",
      emudeckHint: "We recommend installing EmuDeck (emudeck.com): the launcher detects its emulators and your ROMs automatically. You can also locate the executable by hand.",
      scan: "Scan my library",
      scanFound: "{count, plural, one {# file found} other {# files found}} in your library.",
      scanNone: "No matching ROM was found. Select it manually.",
      error: "Could not update the emulator.",
    },
    userFiles: {
      title: "Files you must provide",
      lead: "This pack includes files the server does not distribute (for example, a dump of your own cartridge). Select them here; they are verified against the pack's hash before being accepted.",
      provide: "Select file",
      provided: "Provided",
