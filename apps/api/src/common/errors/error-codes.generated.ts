...
export const ApiErrorCode = {
  ...
  CHANGELOG_CONTENT_INVALID: 'CHANGELOG_CONTENT_INVALID',
  CHANGELOG_ENTRY_NOT_FOUND: 'CHANGELOG_ENTRY_NOT_FOUND',
  CHANGELOG_SPANISH_REVIEW_REQUIRED: 'CHANGELOG_SPANISH_REVIEW_REQUIRED',
...
export const API_ERROR_FALLBACK_ES: Record<ApiErrorCode, string> = {
  ...
  CHANGELOG_CONTENT_INVALID:
    'Revisa el contenido de la novedad antes de guardarla.',
  CHANGELOG_ENTRY_NOT_FOUND: 'Esta novedad ya no existe.',
  CHANGELOG_SPANISH_REVIEW_REQUIRED:
    'Revisa la traducción al español antes de publicar la novedad.',
