...
// @ts-nocheck — vendored Pokémon Showdown scripts mod table: battle-engine callbacks are not statically typeable against @pkmn/sim.
import type {ModdedBattleScriptsData, ActiveMove, Pokemon} from '@pkmn/sim';
