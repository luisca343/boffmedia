...
import {
  ...
  FullMove,
  PokemonMoveEntry,
} from './entities/pokemon-move.entity';
import {
  AbilityCount,
  AbilityInfo,
  PokemonAbilityEntry,
...
export class PokemonController {
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokémon.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokémon names.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve next and previous Pokémon.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokémon evolution tree.',
  })
  @ApiParam({ name: 'id', description: 'Pokémon ID', type: Number })
  ...
  @Get('moves')
  @ApiOperation({
    summary: 'Get all Pokémon moves, and how many Pokémon learn them',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve all Pokémon moves.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokémon moves.',
  })
  @ApiParam({ name: 'id', description: 'Pokémon ID', type: Number })
  ...
  async getPokemonByMove(
    ...
    return this.pokemonFacadeService.getPokemonByMove(
      name,
    ) as unknown as Promise<PokemonMoveEntry[]>;
  }
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve abilities.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve ability.',
  })
  ...
  async getPokemonByBiome(
    @Param('name') name: string,
  ): Promise<BiomeSpawnCollection> {
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve item sprite.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to register Pokémon.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokédex statistics.',
  })
  @ApiParam({ name: 'uuid', description: 'User UUID' })
  ...
  @ApiNotFoundResponse({ description: 'User not found.' })
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve detailed Pokédex status.',
  })
  @ApiParam({ name: 'uuid', description: 'User UUID' })
  ...
  @ApiNotFoundResponse({ description: 'User not found.' })
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokédex registries.',
  })
  @ApiParam({ name: 'uuid', description: 'User UUID' })
  async getPokedexRegistries(
    @Param('uuid') uuid: string,
  ): Promise<PokedexRegistry[]> {
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Showdown data.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Wordle data.',
  })
  async getWordleData() {
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve sprite manifest.',
  })
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        message: {
          type: 'string',
          example: 'Sprite manifest refreshed successfully',
        },
      },
    },
  })
  @ApiInternalServerErrorResponse({
    description: 'Failed to refresh sprite manifest.',
  })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve PMD portrait.',
  })
  @ApiParam({ name: 'name', description: 'Pokémon name', example: 'Pikachu' })
  ...
  @ApiInternalServerErrorResponse({
    description: 'Failed to retrieve Pokémon count.',
  })
