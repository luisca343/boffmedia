...
export const REWARDS: Reward[] = [
  ...
  {
    name: 'Gema prisma pequeña',
    type: 'Gemas pequeñas',
    itemId: 'teras:gema_prisma_peque',
    value: 320,
    width: 1,
    height: 1,
  },
  {
    name: 'Gema blanca pequeña',
    type: 'Gemas pequeñas',
    itemId: 'teras:gema_blanca_peque',
    value: 300,
    width: 1,
    height: 1,
  },
  {
    name: 'Gema roja pequeña',
    type: 'Gemas pequeñas',
    itemId: 'teras:gema_roja_peque',
    value: 280,
    width: 1,
    height: 1,
  },
  {
    name: 'Gema azul pequeña',
    type: 'Gemas pequeñas',
    itemId: 'teras:gema_azul_peque',
    value: 280,
    width: 1,
    height: 1,
  },
  {
    name: 'Gema verde pequeña',
    type: 'Gemas pequeñas',
    itemId: 'teras:gema_verde_peque',
    value: 280,
    width: 1,
    height: 1,
  },
  ...
  {
    name: 'Piedra Teras',
    type: 'Piedras especiales',
    itemId: 'teras:piedra_teras',
    value: 750,
    width: 2,
    height: 2,
  },
  ...
  {
    name: 'Pieza de deseo',
    type: 'Piezas de deseo',
    itemId: 'pixelmon:wishing_piece',
    value: 600,
    width: 2,
    height: 2,
  },
  {
    name: 'Pieza de deseo acuática',
    type: 'Piezas de deseo',
    itemId: 'teras:waterdude_wishing_piece',
    value: 600,
    width: 2,
    height: 2,
  },
  ...
  {
    name: 'Hélix cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_helix_fossil',
    value: 180,
    width: 2,
    height: 2,
  },
  {
    name: 'Domo cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_dome_fossil',
    value: 180,
    width: 2,
    height: 2,
  },
  {
    name: 'Ámbar cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_old_amber',
    value: 190,
    width: 2,
    height: 2,
  },
  {
    name: 'Raíz cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_root_fossil',
    value: 170,
    width: 2,
    height: 2,
  },
  {
    name: 'Garra cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_claw_fossil',
    value: 170,
    width: 2,
    height: 2,
  },
  {
    name: 'Cráneo cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_skull_fossil',
    value: 175,
    width: 2,
    height: 2,
  },
  {
    name: 'Coraza cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_armor_fossil',
    value: 175,
    width: 2,
    height: 2,
  },
  {
    name: 'Tapa cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_cover_fossil',
    value: 160,
    width: 2,
    height: 2,
  },
  {
    name: 'Pluma cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_plume_fossil',
    value: 160,
    width: 2,
    height: 2,
  },
  {
    name: 'Mandíbula cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_jaw_fossil',
    value: 185,
    width: 3,
    height: 2,
  },
  {
    name: 'Aleta cubierta',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_sail_fossil',
    value: 185,
    width: 3,
    height: 2,
  },
  {
    name: 'Pájaro cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_bird_fossil',
    value: 170,
    width: 2,
    height: 2,
  },
  {
    name: 'Pez cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_fish_fossil',
    value: 170,
    width: 2,
    height: 2,
  },
  {
    name: 'Dragón cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_drake_fossil',
    value: 195,
    width: 3,
    height: 2,
  },
  {
    name: 'Dino cubierto',
    type: 'Fósiles cubiertos',
    itemId: 'teras:covered_dino_fossil',
    value: 195,
    width: 3,
    height: 2,
  },
  ...
  },
  {
    name: 'Tabla linfa',
    type: 'Tablas',
    itemId: 'pixelmon:splash_plate',
    value: 300,
    width: 2,
    height: 2,
  },
  {
    name: 'Tabla siniestra',
    type: 'Tablas',
    itemId: 'pixelmon:spooky_plate',
    value: 300,
    width: 2,
    height: 2,
  },
...
function assertFits(rewards: Reward[]) {
  ...
  if (tooLong.length) {
    throw new Error(
      `Values exceed their column width:\n  ${tooLong.join('\n  ')}`,
    );
  }
...
export async function main() {
  ...
  logger.info(
    `Inserted ${inserted}, updated ${updated}. ${n} reward rows present.`,
  );
