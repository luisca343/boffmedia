// The desktop app's message catalogue. Two locales, kept key-for-key in sync — a
...
const es = {
  ...
  common: {
    ...
    // The datakit's strings (@boffmedia/ui/datakit), beside the primitives'
    // for the same reason: the design system reads them through configureUi,
    // so the host owns the text.
    dkLive: {
      live: "En vivo",
      playing: "Jugando",
      pending: "Pendiente",
    ...
    dkExtras: {
      ...
      searchCountryPh: "Buscar país…",
      clear: "Limpiar",
      noMatchesFor: "Sin coincidencias para «{query}».",
      removeCountry: "Quitar {name}",
      defaultNoun: "resultados",
      searchPh: "Buscar…",
      unfollow: "Dejar de seguir",
      follow: "Seguir",
      following: "Siguiendo",
      trendAria: "Progresión",
    },
  },
  ...
  settings: {
    ...
    jvm: {
      title: "Parámetros de la JVM",
      label: "Parámetros",
      hint: "Separados por espacios. Se aplican a los packs que no tengan los suyos",
      placeholder: "-XX:+UseG1GC -Xms2G",
      none: "Ninguno",
      count: "{count} en uso",
      memoryNote:
    ...
    sections: {
      appearance: {
        title: "Apariencia",
        lead: "Idioma, tamaño y cómo se ven los packs.",
      },
      game: {
        title: "Juego",
        lead: "Memoria, Java y dónde se instala todo.",
      },
      emulators: {
        title: "Emuladores",
        lead: "Rutas de los emuladores y carpetas de ROMs.",
      },
      account: {
        title: "Cuenta",
    ...
    uiScale: {
      ...
      label: "Escala",
      hint: "Amplía todo — texto, iconos y espaciado — como el zoom del navegador. Se aplica al momento.",
    },
    packLayout: {
      title: "Biblioteca",
    ...
    account: {
      ...
      boffAccounts: "Cuentas de Boffmedia",
      boffActive: "Activa",
      useBoffAccount: "Usar",
      addBoffAccount: "Añadir cuenta de Boffmedia",
      signOutBoff: "Cerrar sesión",
    },
    emulators: {
      title: "Emuladores",
      mgba: "mGBA",
      melonds: "melonDS",
      emulatorLabel: "{name} — {source}",
      resolved: "Resuelto",
  ...
  browse: {
    ...
    connectorSubstituted: "Sustituido por la versión de NeoForge",
    connectorCompanionsAdded: "Connector y Forgified Fabric API añadidos",
  ...
  packs: {
    ...
    optionalCount: "{count} opcional(es)",
  ...
  packDetail: {
    ...
    // Dice «.mrpack» porque el otro también es un pack de servidor: éste es el
    // manifiesto que consume mrpack-install o el panel de tu hosting.
    exportServerMenu: "Exportar .mrpack de servidor",
    publishMenu: "Publicar en Boffmedia",
    sharePageMenu: "Ver la página pública",
  ...
  publish: {
    title: "Publicar en Boffmedia",
    checking: "Comprobando el pack…",
    planError: "No se pudo preparar la publicación.",
    invalidTitle: "El manifiesto no es válido",
    ...
    upload: "Se subirá",
    uploadValue: "{count} archivo(s) · {size}",
    nothingToUpload: "Nada: el servidor ya lo tiene todo",
    target: "Destino",
    ...
    draftToast: "«{name}» subido como borrador.",
  ...
  content: {
    ...
    optionalDefaultOff: "Desactivado por defecto",
    optionalNone: "Ninguno",
    optionalNeedsDownload: "Falta descargar",
    optionalDeferred: "Se aplica al reiniciar",
    optionalRequires: "Necesita: {names}",
    optionalPickOne: "Elige uno",
    optionalPickAny: "Elige los que quieras",
    optionalPickAtMostOne: "Elige uno o ninguno",
    optionalSummary: "{on} de {total} activas · {size}",
    optionalGroupCount: "{on} / {total}",
    optionalBreaks: "Si lo quitas, deja de funcionar: {names}",
    ...
    optionalEditor: {
      ...
      errorRequiresUnknown:
        "La opción «{name}» depende de «{id}», que ya no existe en este pack.",
    },
    ...
    noUpdates: "Todo está al día.",
    updateAvailable: "{count} actualización(es) disponible(s).",
    updateCheckError: "No se pudieron buscar actualizaciones.",
    disabledBadge: "Desactivado",
    notInstalledBadge: "Sin instalar",
    neededBy: "Lo necesita: {names}",
    openOnPlatform: "Ver en Modrinth",
  ...
  instanceSpace: {
    ...
    javaTileManaged: "Gestionado por la app",
  ...
  emulatorSetup: {
    ...
    emulatorRow: {
      ...
      change: "Cambiar",
      clear: "Deshacer",
      unresolved: "No encontrado",
      staleOverride: "Ruta guardada ya no existe",
      emudeckHint: "Descarga EmuDeck para una instalación rápida:",
      source: {
        override: "Personalizado",
        emudeck: "EmuDeck",
        system: "Sistema",
    ...
    romChecklist: {
      title: "ROMs requeridas",
      scan: "Buscar en mi biblioteca",
      scanning: "Escaneando…",
    ...
    emulatorPathSet: "Ruta del emulador establecida",
    emulatorPathChanged: "Ruta del emulador actualizada",
    emulatorPathCleared: "Ruta del emulador eliminada",
    emulatorPathError: "No se pudo actualizar la ruta del emulador",
    fileProvided: "Archivo proporcionado",
    wrongHashError: "El archivo no coincide. Se esperaba: {hint}",
...
const en = {
  ...
  settings: {
    ...
    jvm: {
      title: "JVM arguments",
      label: "Arguments",
      hint: "Space-separated. Applied to packs that do not set their own",
      placeholder: "-XX:+UseG1GC -Xms2G",
      none: "None",
      count: "{count} in use",
      memoryNote:
    ...
    sections: {
      appearance: {
        title: "Appearance",
        lead: "Language, size, and how packs are shown.",
      },
      game: {
        title: "Game",
        lead: "Memory, Java, and where everything is installed.",
      },
      emulators: {
        title: "Emulators",
        lead: "Emulator paths and ROM folders.",
      },
      account: {
        title: "Account",
    ...
    uiScale: {
      ...
      label: "Scale",
      hint: "Enlarges everything — text, icons and spacing — like browser zoom. Applies immediately.",
    },
    packLayout: {
      title: "Library",
      label: "Pack view",
    ...
    account: {
      ...
      boffActive: "Active",
      useBoffAccount: "Use",
      addBoffAccount: "Add Boffmedia account",
      signOutBoff: "Sign out",
    },
    emulators: {
      title: "Emulators",
      mgba: "mGBA",
  ...
  browse: {
    ...
    connectorSubstituted: "Replaced with the NeoForge build",
    connectorCompanionsAdded: "Connector and Forgified Fabric API added",
  ...
  packDetail: {
    ...
    // Says ".mrpack" because the other one is a server pack too: this is the
    // manifest mrpack-install or your host's panel consumes.
    exportServerMenu: "Export server .mrpack",
    publishMenu: "Publish to Boffmedia",
    sharePageMenu: "View the public page",
  ...
  publish: {
    title: "Publish to Boffmedia",
    checking: "Checking the pack…",
    planError: "Could not prepare the publish.",
    invalidTitle: "The manifest is not valid",
    warningsTitle: "Warnings",
    pack: "Pack",
    version: "Version",
    files: "Files",
    optionalFeatures: "Options",
    upload: "Will upload",
    uploadValue: "{count} file(s) · {size}",
    nothingToUpload: "Nothing: the server already has it all",
    target: "Target",
    ...
    publish: "Publish",
    publishedToast: "“{name}” published.",
    draftToast: "“{name}” uploaded as a draft.",
  ...
  content: {
    ...
    optionalDefaultOff: "Off by default",
    optionalNone: "None",
    optionalNeedsDownload: "Not downloaded",
    optionalDeferred: "Applies on restart",
    optionalRequires: "Needs: {names}",
    optionalPickOne: "Pick one",
    optionalPickAny: "Pick any",
    optionalPickAtMostOne: "Pick one or none",
    optionalSummary: "{on} of {total} on · {size}",
    optionalGroupCount: "{on} / {total}",
    optionalBreaks: "Turning this off breaks: {names}",
    ...
    optionalEditor: {
      ...
      errorRequiresUnknown:
        "Option “{name}” depends on “{id}”, which no longer exists in this pack.",
    },
    ...
    openOnPlatform: "View on Modrinth",
  ...
  instanceSpace: {
    ...
    javaTileManaged: "Managed by the app",
  ...
  emulatorSetup: {
    ...
    emulatorRow: {
      ...
      staleOverride: "Saved path no longer exists",
      emudeckHint: "Download EmuDeck for quick setup:",
      source: {
        override: "Custom",
        emudeck: "EmuDeck",
        system: "System",
    ...
    emulatorPathSet: "Emulator path set",
    emulatorPathChanged: "Emulator path updated",
    emulatorPathCleared: "Emulator path cleared",
    emulatorPathError: "Could not update emulator path",
