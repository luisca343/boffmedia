...
export const getDayNightIcon = (ticks: number): JSX.Element => {
  if ((ticks >= 22500 && ticks < 24000) || (ticks >= 0 && ticks < 300)) return <Sunrise className="h-6 w-6 text-primary-light0" />;
  ...
  if (ticks >= 12000 && ticks < 13800) return <Sunset className="h-6 w-6 text-primary-light0" />;
  ...
  return <Cloud className="h-6 w-6 text-text-tertiary" />;
};
