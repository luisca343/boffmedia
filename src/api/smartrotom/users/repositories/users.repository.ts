...
export class UsersRepository 
  extends BaseRepositoryImpl<SmartRotomUser, CreateSmartrotomUserDto, UpdateSmartrotomUserDto> 
  ...
  async create(createUserDto: CreateSmartrotomUserDto): Promise<SmartRotomUser> {
    const result = await this.db.insert(smartrotomUsers)
      .values({
  ...
  async update(id: number, updateUserDto: UpdateSmartrotomUserDto): Promise<SmartRotomUser> {
  ...
  async delete(id: number): Promise<boolean> {
    const result = await this.db.delete(smartrotomUsers)
      .where(eq(smartrotomUsers.id, id));
  ...
  async findByUuids(uuids: string[]): Promise<{ [uuid: string]: SmartRotomUser | null }> {
