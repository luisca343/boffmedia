...
export class ArcadeController {
  ...
  async getArcadeStreak(@Param('uuid') uuid: string): Promise<ArcadeStreakResponse> {
  ...
  async claimDailyReward(@Body() body: { uuid: string }): Promise<ClaimRewardResponse> {
  ...
  async claimInventoryItems(@Body() data: ClaimInventoryItemsRequest): Promise<ClaimInventoryItemsResponse> {
  ...
  async addInventoryItem(@Body() data: AddInventoryItemRequest): Promise<AddInventoryItemResponse> {
  ...
  async consumeInventoryItem(@Body() data: { uuid: string; itemId: string }): Promise<ConsumeInventoryItemResponse> {
  ...
  async giveLootbox(@Body() data: { uuid: string; lootboxType: string, amount?: number }): Promise<GiveLootboxResponse> {
