import { Controller, Get, Param, Query, HttpStatus, UseInterceptors, Delete, Post, ValidationPipe, UsePipes, Body } from '@nestjs/common';
...
export class MhwildsController {
  ...
  async getWeapons(@Query() dto: GetWeaponsDto): Promise<WeaponEntity[]> {
    return await this.mhwildsFacadeService.getWeapons(dto.locale || Locale.SPANISH);
  }
  ...
  async getArmor(@Query() dto: GetArmorDto): Promise<ArmorEntity[]> {
    return await this.mhwildsFacadeService.getArmor(dto.locale || Locale.SPANISH);
  }
  ...
  async getCharms(@Query() dto: GetCharmsDto): Promise<CharmEntity[]> {
    return await this.mhwildsFacadeService.getCharms(dto.locale || Locale.SPANISH);
  }
  ...
  async getDecorations(@Query() dto: GetDecorationsDto): Promise<DecorationEntity[]> {
    return await this.mhwildsFacadeService.getDecorations(dto.locale || Locale.SPANISH);
  }
  ...
  async getSkills(@Query() dto: GetSkillsDto): Promise<SkillEntity[]> {
    return await this.mhwildsFacadeService.getSkills(dto.locale || Locale.SPANISH);
  }
  ...
  async getAllCharmRanks(@Query() dto: GetCharmRanksDto): Promise<CharmRankEntity[]> {
    return await this.mhwildsFacadeService.getAllCharmRanks(dto.locale || Locale.SPANISH);
  }
  ...
  async createWeaponTree(@Query() dto: GetWeaponTreeDto): Promise<WeaponTreeEntity> {
    return await this.mhwildsFacadeService.createWeaponTree(dto.locale || Locale.SPANISH);
  }
  ...
  async searchWeaponsByName(
    ...
    return await this.mhwildsFacadeService.searchWeaponsByName(dto.locale || Locale.SPANISH, searchTerm);
  }
  ...
  async getWeaponsByKind(
    ...
    return await this.mhwildsFacadeService.getWeaponsByKind(dto.locale || Locale.SPANISH, kind);
  }
  ...
  async getArmorByRarity(
    ...
    return await this.mhwildsFacadeService.getArmorByRarity(dto.locale || Locale.SPANISH, rarity);
  }
  ...
  async getDataStatistics(@Query() dto: GetWeaponsDto) {
    return await this.mhwildsFacadeService.getDataStatistics(dto.locale || Locale.SPANISH);
  }
  ...
  async clearCache(@Query() dto: ClearCacheDto): Promise<CacheOperationResultEntity> {
    return await this.mhwildsFacadeService.clearCache(dto.resourceType, dto.locale);
  }
  ...
  async warmupCache(@Body() dto: WarmupCacheDto): Promise<CacheOperationResultEntity> {
    return await this.mhwildsFacadeService.warmupCache(dto.locale || Locale.SPANISH);
  }
  ...
  async validateCache(@Body() dto: ValidateCacheDto): Promise<CacheOperationResultEntity> {
    return await this.mhwildsFacadeService.validateCache(dto.locale || Locale.SPANISH);
  }
