...
export class PackService {
  ...
  async getBoosterPacks(expansion?: string): Promise<TcgpBoosterPack[]> {
    try {
      return await this.ptcgpRepository.findBoosterPacksByExpansion(expansion);
    } catch (error) {
  ...
  async createBoosterPack(packData: Partial<TcgpBoosterPack>) {
    ...
    try {
      ...
      return await this.ptcgpRepository.createBoosterPack(packData);
    } catch (error) {
  ...
  async getBestPackForEvent(username: string, eventCards: string[], expansion: string) {
    ...
    try {
      ...
      return await this.getBestPackForExpansion(username, expansion);
    } catch (error) {
