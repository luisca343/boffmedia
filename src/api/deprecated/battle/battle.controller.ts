...
import { CreateReplayDto, UpdateReplayDto, ShareReplayDto } from './_dto/replay.dto';
import { CreateBattleConfigDto, UpdateBattleConfigDto } from './_dto/battle-config.dto';
...
export class BattleController {
  ...
  @ApiParam({ name: 'uuid', description: 'Player UUID', example: '007d1a64-661c-4396-8844-e27856f2ddfa' })
  ...
  async createReplay(@Body() createReplayDto: CreateReplayDto): Promise<BattleReplay> {
  ...
  async shareReplay(
    ...
    return await this.battleFacadeService.shareReplayWithUser(replayId, targetUuid, sourceUuid);
  }
  ...
  @ApiParam({ name: 'npcConfigName', description: 'NPC configuration name', example: 'gym-leader-brock' })
  async getBattleConfig(@Param('npcConfigName') npcConfigName: string): Promise<BattleConfig> {
  ...
  @ApiParam({ name: 'npcConfigName', description: 'NPC configuration name', example: 'gym-leader-brock' })
  async deleteBattleConfig(@Param('npcConfigName') npcConfigName: string): Promise<BattleOperationResponse> {
