...
export function SettingsPage({ setTema } : { setTema: (tema: string) => void}){
    ...
    return (
        <div>
            ...
            <div className="flex flex-col p-2 bg-primary-500 text-surface-50 ">
            ...
            <button className="text-surface-50 mx-1 bg-black" onClick={() => signIn('boffmedia')}>Sign in</button>
            <button className="text-surface-50 mx-1 bg-black" onClick={() => signOut()}>Sign out</button>
            <h1>Settings</h1>
