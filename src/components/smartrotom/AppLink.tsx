  ...
  return (
    <motion.div
        ...
        <Link href={`/smartrotom/${app.url}`}>
            <div className="w-24 h-24 sm:w-36 sm:h-36"><Image src={`http://i.lizardon.es/pixelmon/img/iconos/apps/${app.name}.webp`} alt={app.name} width={150} height={150}  className="w-full h-full" /></div>
