...
export default function PokemonSprite({pokemon, id, className}: {pokemon: DetailedPokemon | null, id: string, className?: string}) {
    ...
    return ( <>
    <div className={`w-48 h-48 absolute ${className} z-[100]`} style={{width:200, height:200}}>
    ...
    <div className={`w-48 h-48 absolute flex flex-col justify-end ${className}`} id={id} style={{width:200, height:200}}>
