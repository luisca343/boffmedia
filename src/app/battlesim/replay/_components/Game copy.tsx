...
return (
  <div>
<div className="w-full h-full flex bg-surface-700">
  ...
  <PlayerDataBar battle={battle} side={1} viewPoint={viewPoint}/>
    </div>
        <Button onClick={() => {
        ...
        const avatar = Sprites.getAvatar(avatarId)
          return (
            <div className={`w-[20%] h-full flex justify-center ${viewPoint[viewPoint[side]] === 0 ? 'flex-col' : 'flex-col-reverse'}`}>
              ...
              <div className="text-shadow-border1 text-surface-50 text-center">{battleSide.name}</div>
