...
export function ReplayControls({
    ...
    return(
        <div className="flex justify-between p-2 bg-surface-3 space-x-2" style={{ width: `${canvasWidth + (logVisible ? 400 : 0)}px` }}>
            ...
            <div className="flex space-x-2">
                ...
                <Input
                    className="w-32 border border-border-dark"
                    type="string"
            ...
            <div className="flex space-x-2">
                ...
                <Input
                    className="w-20 border border-border-dark"
                    type="number"
                    value={turnInput}
