  ...
  return (
    <BoffLayout>
      <div className="max-w-2xl mx-auto">
        ...
        <p className="mb-4 text-primary-100">
          Para más información sobre reembolsos y disputas, por favor consulta nuestra <Link href="/politicas/reembolsos" className="text-primary-400 hover:text-primary-300 transition duration-300">Política de Disputas y Reembolsos</Link>.
        </p>
      </div>
    </BoffLayout>
  );
