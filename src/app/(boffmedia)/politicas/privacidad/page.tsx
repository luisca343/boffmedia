  ...
  return (
    <BoffLayout>
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-primary-600">Política de Privacidad</h1>
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">1. Información que Recopilamos</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">2. Uso de la Información</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">3. Compartir Información</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">4. Seguridad de Datos</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">5. Tus Derechos</h2>
        <p className="mb-4 text-primary-100">
          Tienes derecho a:
        </p>
        <ul className="list-disc list-inside mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">6. Cookies y Tecnologías Similares</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">7. Cambios en esta Política</h2>
        <p className="mb-4 text-primary-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary-400">8. Contacto</h2>
        <p className="mb-4 text-primary-100">
          Si tienes preguntas sobre esta Política de Privacidad, por favor contáctanos a través de nuestra <Link href="/contacto" className="text-primary-400 hover:text-primary-300 transition duration-300">página de contacto</Link>.
        </p>
