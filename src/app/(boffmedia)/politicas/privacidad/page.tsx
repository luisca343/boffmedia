  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <ul className="list-disc list-inside mb-4 text-primary-100">
        <li>
          Información de registro: nombre de usuario, dirección de correo
        ...
        <li>
          Información de pago: para procesar compras dentro del juego
          (gestionada por procesadores de pago seguros).
        </li>
      </ul>
      ...
      <p className="mb-4 text-primary-100">Utilizamos tu información para:</p>
      <ul className="list-disc list-inside mb-4 text-primary-100">
      ...
      <ul className="list-disc list-inside mb-4 text-primary-100">
        ...
        <li>
          Con proveedores de servicios que nos ayudan a operar nuestros juegos y
          sitio web.
        </li>
        <li>
      ...
      <p className="mb-4 text-primary-100">
        ...
        proteger tu información personal contra acceso no autorizado, pérdida o
        alteración.
      </p>
      ...
      <p className="mb-4 text-primary-100">Tienes derecho a:</p>
      <ul className="list-disc list-inside mb-4 text-primary-100">
      ...
      <p className="mb-4 text-primary-100">
        ...
        de nuestro sitio web y servicios de juego. Puedes gestionar tus
