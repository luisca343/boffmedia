  ...
  return (
    <BoffLayout>
      <div className="max-w-2xl mx-auto">
        ...
        <p className="mb-4 text-primary-light">
          Para más información sobre reembolsos y disputas, por favor consulta nuestra <Link href="/politica-de-disputas" className="text-primary hover:text-primary transition duration-300">Política de Disputas y Reembolsos</Link>.
        </p>
      </div>
    </BoffLayout>
  );
