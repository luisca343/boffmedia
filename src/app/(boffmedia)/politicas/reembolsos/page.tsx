  ...
  return (
    <BoffLayout>
      <div className="max-w-2xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-orange-600">Política de Disputas y Reembolsos</h1>
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">Proceso de Disputa</h2>
        <p className="mb-4 text-orange-100">
          Si tienes algún problema con tu compra, sigue estos pasos:
        </p>
        <ol className="list-decimal list-inside mb-4 text-orange-100">
          <li>Contacta a nuestro servicio de atención al cliente a través de nuestra <Link href="/contacto" className="text-orange-400 hover:text-orange-300 transition duration-300">página de contacto</Link>.</li>
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">Política de Reembolsos</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">Proceso de Reembolso</h2>
        <p className="mb-4 text-orange-100">
        ...
        <p className="mb-4 text-orange-100">
          Para más información sobre cancelaciones, consulta nuestra <Link href="/politicas/devoluciones" className="text-orange-400 hover:text-orange-300 transition duration-300">Política de Cancelaciones</Link>.
        </p>
      </div>
    </BoffLayout>
  );
