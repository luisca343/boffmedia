  ...
  return (
    <BoffLayout>
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-hover">Términos de Servicio</h1>
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">1. Aceptación de los Términos</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">2. Cambios en los Términos</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">3. Uso del Servicio</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">4. Cuentas de Usuario</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">5. Contenido del Usuario</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">6. Propiedad Intelectual</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">7. Compras y Pagos</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">8. Terminación</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">9. Limitación de Responsabilidad</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">10. Ley Aplicable</h2>
        <p className="mb-4 text-primary-light">
        ...
        <h2 className="text-2xl font-bold mb-4 text-primary">11. Contacto</h2>
        <p className="mb-4 text-primary-light">
          Si tienes preguntas sobre estos Términos de Servicio, por favor contáctanos a través de nuestra <Link href="/contacto" className="text-primary hover:text-primary transition duration-300">página de contacto</Link>.
        </p>
