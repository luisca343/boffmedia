  ...
  return (
    <BoffLayout>
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-orange-600">Términos de Servicio</h1>
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">1. Aceptación de los Términos</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">2. Cambios en los Términos</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">3. Uso del Servicio</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">4. Cuentas de Usuario</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">5. Contenido del Usuario</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">6. Propiedad Intelectual</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">7. Compras y Pagos</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">8. Terminación</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">9. Limitación de Responsabilidad</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">10. Ley Aplicable</h2>
        <p className="mb-4 text-orange-100">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-400">11. Contacto</h2>
        <p className="mb-4 text-orange-100">
          Si tienes preguntas sobre estos Términos de Servicio, por favor contáctanos a través de nuestra <Link href="/contacto" className="text-orange-400 hover:text-orange-300 transition duration-300">página de contacto</Link>.
        </p>
