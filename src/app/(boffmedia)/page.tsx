...
export default function GamingLandingPage() {
  return (
    <BoffLayout>
        ...
        <div className="relative z-10">
          <main className="container mx-auto px-4">
            <section className="mb-24 text-center">
              ...
              <p className="text-2xl mb-10 text-text-secondary max-w-3xl mx-auto">
              ...
              <div className="flex justify-center space-x-6">
                ...
                <Link
                  href="/comunidad"
                  className="bg-surface-3 text-white px-8 py-4 rounded-full font-bold text-xl hover:bg-surface-3 transition duration-300 inline-flex items-center border-2 border-purple-500"
                >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    link: "/smartrotom",
                    color: "from-primary-light0 to-red-600",
                  },
                  {
                  ...
                  <div
                    key={index}
                    className="bg-surface-3 p-8 rounded-lg border border-border-dark shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-1"
                  >
                    <div
      ...
      className="flex-grow px-6 py-4 rounded-full border-2 border-purple-500 bg-surface-3 text-white mb-4 sm:mb-0 sm:mr-4 focus:outline-none focus:ring-2 focus:ring-purple-500"
      required
      />
      <button
      type="submit"
      ...
      className="text-text-secondary hover:text-purple-400 transition duration-300"
      >
