...
export default function GamingLandingPage() {
  return (
    <BoffLayout>
        ...
        <div className="relative z-10">
          <main className="container mx-auto px-4">
            <section className="mb-24 text-center">
              ...
              <p className="text-2xl mb-10 text-surface-300 max-w-3xl mx-auto">
              ...
              <div className="flex justify-center space-x-6">
                ...
                <Link
                  href="/comunidad"
                  className="bg-surface-800 text-white px-8 py-4 rounded-full font-bold text-xl hover:bg-surface-700 transition duration-300 inline-flex items-center border-2 border-purple-500"
                >
            ...
            <section className="mb-24">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-surface-800 p-8 rounded-lg border border-surface-700 shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-1"
                  >
                    <div
                    ...
                    <p className="text-surface-300 mb-6">{item.description}</p>
                    <Link
                      href={item.link}
      ...
      <p className="text-xl mb-10 text-surface-300 max-w-2xl mx-auto">
      ...
      className="flex-grow px-6 py-4 rounded-full border-2 border-purple-500 bg-surface-800 text-white mb-4 sm:mb-0 sm:mr-4 focus:outline-none focus:ring-2 focus:ring-purple-500"
      required
      />
      <button
      type="submit"
      ...
      className="text-surface-300 hover:text-purple-400 transition duration-300"
      >
