      ...
      <div className="mb-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-block relative">
            <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-accent-400 to-secondary-400 mb-4">
              Centro de Eventos
            </h1>
              ...
              <div className="flex bg-surface-700/50 rounded-lg p-1 border border-surface-600">
                <Button
                  ...
                  className={`px-4 ${viewMode === 'grid' 
                    ? "bg-gradient-to-r from-accent-600 to-secondary-600 text-white" 
