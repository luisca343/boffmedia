...
export function Header() {
  ...
  return (
    <header className="fixed top-[42px] left-0 right-0 z-40 bg-white border-b border-gray-200 h-14 flex items-center justify-between px-0">
      <div id="app_nome" className="w-60 flex items-center justify-between pl-4 border-r border-gray-200 pr-4 h-full">
