    ...
    <BoffLayout>
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <div className="mb-4">
            <label htmlFor="name" className="block text-orange-300 mb-2">Nombre</label>
            <input
              type="text"
              id="name"
              name="name"
              ...
              className="w-full p-2 rounded bg-gray-700 text-white border border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500"
              required
            />
          </div>
          <div className="mb-4">
            <label htmlFor="email" className="block text-orange-300 mb-2">Correo Electrónico</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <div className="mb-4">
            <label htmlFor="message" className="block text-orange-300 mb-2">Mensaje</label>
            <textarea
              id="message"
              name="message"
