              ...
              <div className="backdrop-blur-md bg-black/30 rounded-2xl p-8 shadow-xl border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div>
                      <p className="text-sm text-text-tertiary mb-1">Número</p>
                      <p className="text-xl text-white">{cardData.number}</p>
                    </div>
                    <div>
                      <p className="text-sm text-text-tertiary mb-1">Expansión</p>
                      <p className="text-xl text-white">{trans(cardData.expansion)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-text-tertiary mb-1">Rareza</p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <p className="text-sm text-text-tertiary mb-1">PS</p>
                      <p className="text-xl text-white">{cardData.hp}</p>
                    </div>

                    <div>
                      <p className="text-sm text-text-tertiary mb-1">Debilidad</p>
                      <div className="flex items-center gap-2">
                        <div className="p-1 bg-white/10 rounded-full">
                          <Image
                    ...
                    <div>
                      <p className="text-sm text-text-tertiary mb-1">Coste de Retirada</p>
                      <div className="flex items-center gap-2">
