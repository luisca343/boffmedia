...
export default function UserGallery() {
    ...
    return (
      <BoffLayout>
        <div className="flex flex-col items-center justify-center min-h-full">
          <h1 className="text-3xl font-bold text-primary-300 mb-4">Cargando...</h1>
          <p className="text-surface-300 mb-6 text-center">Estamos cargando tu galería de cartas. Por favor, espera un momento.</p>
        </div>
      </BoffLayout>
    )
  }
  ...
  if (!session || !session.user) {
    return (
      <BoffLayout>
        <div className="flex flex-col items-center justify-center min-h-full">
          <h1 className="text-3xl font-bold text-primary-300 mb-4">Usuario no encontrado</h1>
    ...
    return (
      <BoffLayout>
        <div className="flex flex-col items-center justify-center min-h-screen">
          <h1 className="text-3xl font-bold text-primary-300 mb-4">Error</h1>
          <p className="text-surface-300 mb-6 text-center">{error}</p>
          <Button
            onClick={() => router.push('/')}
            className="bg-primary-500 hover:bg-primary-600 text-white transition-colors duration-200"
          >
