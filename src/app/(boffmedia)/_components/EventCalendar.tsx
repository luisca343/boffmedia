...
export default function EventCalendar() {
  return (
    <div className="bg-surface-800 p-6 rounded-lg border border-surface-700 shadow-lg">
...
function EventCalendarElement({
  ...
  return (
    <div className="flex items-center space-x-4 p-4 bg-surface-700 rounded-lg">
...
function NoEventsMessage() {
  return (
    <div className="col-span-full flex flex-col items-center justify-center p-8 bg-surface-700 rounded-lg text-center">
