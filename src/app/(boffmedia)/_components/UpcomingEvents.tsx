...
function EventCard({
  ...
  return (
    <div
      className={`bg-surface-3 p-6 rounded-lg border border-border-dark shadow-inner`}
    >
      <h3
...
function NoEventsCard() {
  return (
    <div className="md:col-span-2 bg-surface-3 p-8 rounded-lg border border-border-dark shadow-inner text-center">
