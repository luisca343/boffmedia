...
function EventCard({
  ...
  return (
    <div
      className={`bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-inner`}
    >
      <h3
...
function NoEventsCard() {
  return (
    <div className="md:col-span-2 bg-gray-800 p-8 rounded-lg border border-gray-700 shadow-inner text-center">
