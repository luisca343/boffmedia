...
export default function MoveDataElement({id} : {id: string}){
    ...
    function Cell({ children, isActive, hitsAll }: { children: React.ReactNode, isActive: boolean, hitsAll?: boolean }) {
        const bgColor = isActive && hitsAll ? "bg-red-500" : isActive ? "bg-primary-300" : "bg-slate-600";
        const textColor = isActive ? "text-black" : "text-slate-100";
        const borderColor = isActive && hitsAll ? "border-red-500" : isActive ? "border-primary-300" : "border-slate-600";
            ...
            <div className="text-center">
                <div className="flex  mb-4 justify-center">
                    <HoverCard>
                        ...
                        <HoverCardContent className="bg-slate-800 text-white w-72">
                            <div className="flex items-center mb-2">
                                <div className="w-4 h-4 bg-slate-600 border border-slate-600 mr-2"></div>
