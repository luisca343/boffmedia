...
export async function getPokemonImage(id: number, form: string, palette: string){
    const img = await rotomGET(`/pokemon/image/${id}/${form}/${palette}`)
    return img
}

export async function getPokemonSprite(id: number, form: string, palette: string){
    const img = await rotomGET(`/pokemon/sprite/${id}/${form}/${palette}`)
    return img
}
