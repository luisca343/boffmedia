...
import { Pokemon, Abilities } from "@/types/Pokemon"

export function ClientBasicInfo({ pokemon, formIndex, formName }: { pokemon: Pokemon, formIndex: number, formName: string }) {
    const formsTranslation = useTranslations("")
    ...
    const abilities = pokemon.forms[formIndex].abilities ? pokemon.forms[formIndex].abilities : pokemon.forms[0].abilities as Abilities

    return (
        <section className="flex justify-center items-center">
            <div className="flex flex-col items-center">
                <div className="flex" style={{width:200, height:200}}>
                    <PokemonSprite id={pokemon.dex} form={formName} palette='none' width={200} height={200} pixelated={false} showStatus={false}/>
                </div> 
