...
export function TamagotchiButtons({ onButtonPress }: TamagotchiButtonsProps) {
  return (
    <div className="flex justify-between w-64 relative z-20">
      ...
      <button onClick={() => onButtonPress('B')} className="w-12 h-12 bg-gradient-to-b from-blue-400 to-blue-600 rounded-full border-2 border-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-lg transform transition-transform active:scale-95 relative overflow-hidden" aria-label="B">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,0.3)_0%,_rgba(255,255,255,0)_70%)]"></div>
      </button>
