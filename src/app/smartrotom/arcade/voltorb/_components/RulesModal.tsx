...
export function RulesModal({ isOpen, onClose }: RulesModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[800px] h-[80vh] flex flex-col bg-surface-900 border-4 border-yellow-500 rounded-lg p-0 overflow-hidden">
        <DialogHeader className="bg-surface-800 p-4 border-b-4 border-yellow-500">
          <DialogTitle className="text-center">
            <RainbowText text="Reglas de Gira Voltorb" size="lg" />
          </DialogTitle>
          <DialogDescription className="text-center text-surface-300">
