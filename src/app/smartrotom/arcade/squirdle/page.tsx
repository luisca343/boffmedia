...
export default function EnhancedRetroPokemonGuesser() {
    ...
    <div className="min-h-full w-full bg-gradient-to-b from-purple-900 to-indigo-900 text-white font-mono flex flex-col relative overflow-hidden">
      ...
      <main className="flex-grow p-6 overflow-auto container mx-auto max-w-4xl relative z-10">
        <h1 className="text-4xl font-bold mb-8 text-center animate-pulse">
          <span className="text-pink-500 text-6xl">R</span>
          <span className="text-pink-500">etro </span>
          <span className="text-cyan-400 text-6xl">P</span>
          <span className="text-cyan-400">okémon </span>
          <span className="text-yellow-300 text-6xl">G</span>
          <span className="text-yellow-300">uesser</span>
        </h1>
