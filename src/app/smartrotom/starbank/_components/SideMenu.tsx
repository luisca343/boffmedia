      ...
      >
        <div className="h-full w-full bg-blue-950 flex flex-col  relative z-10">
          <div className="w-full bg-blue-950 h-20  text-blue-100 font-bold italic pointer-events-none flex items-center justify-center">
            <div className="bg-foreground min-w-12 h-12 rounded-full text-center text-9xl flex items-center mx-2">
              <img src="/smartrotom/img/apps/starbank.webp" alt="logo" className="h-12 w-12" />
            </div>
            <AnimatePresence>
              {isOpened && (
                <motion.div variants={menuItemVariants}>
                  <div className="text-text-primary text-4xl font-bold">StarBank</div>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
          <motion.div 
            className="mt-6 ml-4 mr-4 py-4 min-w-32 text-text-tertiary text-6xl grid place-items-center grid-cols-32 auto-cols-min rounded-lg"
