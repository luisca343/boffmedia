  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-lg border border-blue-200 p-5 shadow-sm">
        ...
        <p className="text-xs text-gray-500 mt-2">{accountName}</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-blue-200 p-5 shadow-sm">
        <div className="flex justify-between items-start">
          ...
          <div className={`h-10 w-10 rounded-full ${netBalance >= 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'} flex items-center justify-center`}>
            <TrendingUp className="h-6 w-6" />
          </div>
        </div>
        <p className="text-xs text-gray-500 mt-2">{`${transactionCount} transacciones`}</p>
      </div>
