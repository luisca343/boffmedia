...
export default function History() {
  ...
  return (
    <MenuWrapper className="w-full min-h-full  bg-surface-2 text-white flex flex-col items-center">
        ...
        <div className="space-y-4 overflow-auto">
          {Object.values(mineHistory)
            ...
            .map((game: any, index: number) => (
              <div
                key={index}
                className="flex justify-between items-center border-b border-border-dark pb-2"
              >
