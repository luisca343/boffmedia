        ...
        <nav className="bg-blue-500 p-4 flex justify-center space-x-4">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-yellow-300 text-blue-500 font-bold text-xl transform hover:scale-110 transition-transform hover:bg-white px-4 py-2 rounded-full button-pop-shadow">
                ¡Crear Noticia!
              </Button>
            </DialogTrigger>
