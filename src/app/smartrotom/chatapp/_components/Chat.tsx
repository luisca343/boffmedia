...
export function Chat({chats, activeChat, setActiveChat}: {chats: ChatData[], activeChat: number, setActiveChat: (id: number) => void}) {
    ...
    return (
        <div className="flex flex-col w-full h-full overflow-hidden">
            <div className="h-16 p-2 text-xl w-full bg-zinc-800 flex items-center text-main-50 border-b border-zinc-900" > 
        ...
        }} value={message} type="text" placeholder="Escribe un mensaje" className="h-full bg-zinc-800 text-main-50 border-none rounded-none "/>
