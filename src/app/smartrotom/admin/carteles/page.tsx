...
export default function CartelesAutopista() {
  ...
  return (
    <div className="w-full min-h-full bg-black text-green-400 font-mono p-4">
          ...
          <div className="space-y-4">
              ...
              <div key={index} className="space-y-2">
                ...
                <div className="flex space-x-2">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <SelectTrigger id={`dir-${index}`} className="bg-surface-800 text-green-400 border-green-500">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="bg-surface-800 text-green-400 border-green-500 select-content">
            ...
            <div className="relative">
              <Input
                value={signUrl}
                readOnly
                className="pr-10 bg-surface-800 text-green-400 border-green-500"
      ...
      <Card className="mt-6 bg-surface-900 border-green-500 border">
        <CardHeader>
