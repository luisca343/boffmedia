        ...
        <Card className="bg-gray-900 border-green-500 border">
          ...
          <CardContent className="space-y-4">
            <Select onValueChange={setSpeaker} defaultValue={speaker}>
              <SelectTrigger className="w-full bg-gray-800 text-green-400 border-green-500">
                <SelectValue placeholder="Seleccionar emisor" />
              </SelectTrigger>
              <SelectContent className="bg-gray-800 text-green-400 border-green-500">
                {speakers.map((s) => (
                  <SelectItem key={s.value} value={s.value} className="hover:bg-gray-700">
            ...
            <div className="flex space-x-4">
              ...
              <Dialog>
                ...
                <DialogContent className="bg-gray-900 border-green-500 border">
                  <DialogHeader>
